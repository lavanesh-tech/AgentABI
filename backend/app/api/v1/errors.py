...
_DOMAIN_ERROR_MAP: dict[type[Exception], tuple[int, str]] = {
    ...
    InvalidGitHubPullRequestPayload: (status.HTTP_400_BAD_REQUEST, INVALID_REQUEST),
    MissingAgentABIConfiguration: (status.HTTP_422_UNPROCESSABLE_ENTITY, VALIDATION_ERROR),
    InvalidAgentABIConfiguration: (status.HTTP_422_UNPROCESSABLE_ENTITY, VALIDATION_ERROR),
